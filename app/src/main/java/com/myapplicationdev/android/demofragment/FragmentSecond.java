...
public class FragmentSecond extends Fragment implements View.OnClickListener {
    ...
    private void initViews(View view) {
        buttonAddText = view.findViewById(R.id.frag2_add_text_button);
        buttonAddText.setOnClickListener(this::onClick);
        textView = view.findViewById(R.id.frag2_text_view);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.frag2_add_text_button:
